...
| Android app | **Released** ([v0.1.1](https://github.com/Orenda-Project/element-x-android/releases/latest)). A new teacher installed it from the release page and used Rumi following only the teacher guide, 11 of 11 steps, on an emulator. Real phones not tested yet ([#4](https://github.com/Orenda-Project/rumi-messenger/issues/4)) |
